...
/*
<button class="btn btn-light" onclick="document.body.style.backgroundColor = 'white'">Default Background</button>
<button class="btn btn-primary" onclick="document.body.style.backgroundColor = 'blue'">Blue Background</button>
<button class="btn btn-danger" onclick="document.body.style.backgroundColor = 'red'">Red Background</button>
<button class="btn btn-success" onclick="document.body.style.backgroundColor = 'green'">Green Background</button>
*/
}
...
function loadStatsPage(){
	...
	var losses = 0;
	for (var i = 2; i < 14; i++) {
		homeScore = parseInt(document.getElementById("stats_table").rows[i].cells[2].innerHTML);
